...
/*:
 I have made you a little tool that lets you create algorithmic art based on simple rules that are chosen by you. I am using a well known collection of of rules that use Cellular Automata to generate graphical elements on the screen.
 ...
 * Change the number bellow to a number between 0 and 255 so you can see how different the drawings can be. (Rule number 22 is really nice)
...
The top row of pixels is being generated with a random number of alive and dead pixels. After that, that row is used in combination with the rules of the Cellular Automata in order to generate the final image. The algorihm then goes line by line in order to decide if a pixel will be alive or dead.
 
 The patterns you see can be found many times in everyday life. You see them in art made a thousand years ago but also in nature like the patterns of the shells of some water creatures.
 
 Changing the rule number gives you a lot of variability in the drawings. Aditionally, there are two more variables that can help you get to even cooler outputs!
 ...
 */
var randomnessRatio = /*#-editable-code*/70/*#-end-editable-code*/
var pixelSize = /*#-editable-code*/4/*#-end-editable-code*/
...
//: This was your short but beautiful introdution to the infinite world of **Computational** **Art**. Thank you for your time!
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if easterEgg {
            let draw = WorldView(frame: self.view.bounds, cellSize: 16)
